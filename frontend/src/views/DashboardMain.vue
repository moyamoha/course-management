  ...
  <v-container class="content py-10">
    <v-row>
      <v-col sm="8" md="6" lg="4" xs="10">
        ...
        <v-carousel cycle :show-arrows="false" progress progress-color="success"  v-if="atLeastOneItem">
          <v-carousel-item
        ...
        <p v-else class="text-subtitle-2">You are not involved in any course yet!</p>
      </v-col>
      <v-col md="3"></v-col>
    </v-row>
  </v-container>
