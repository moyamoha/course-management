<template>
  <v-container>
    <v-row class="d-flex pt-10">
      <v-col>
        Here you can change your profile picture, email, or other general like adding academy, setting year credit target and so on. 
      </v-col>
    </v-row>
    <v-row>
      ...
      <v-col class="d-md-flex" md="8">
        ...
        <v-col class="d-flex flex-column" md="3">
          ...
          <span>{{new Date(loggedInUser.dateJoined).toLocaleDateString()}}</span>
        </v-col>
    </v-col>
    </v-row>
